...
struct UpdateGratitudeView: View {
    @Environment(\.dismiss) private var dismiss
    @StateObject private var viewModel: UpdateGratitudeViewModel
    ...
    init(container: DIContainer, modelContext: ModelContext, gratitudeMessage: GratitudeResponse) {
        _viewModel = StateObject(wrappedValue: UpdateGratitudeViewModel(
            container: container,
    ...
    private var updateButton: some View {
        GCButton(
            ...
            mode: .filled,
            action: {
                viewModel.updateGratitudeMessage()
            },
